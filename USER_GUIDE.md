...
# 2. View summary
python3 scripts/shannon-scud/token-tracker.py summary

# 3. Check model routing
python3 scripts/shannon-scud/multi-provider-router.py table
```
...
```bash
python3 scripts/shannon-scud/token-tracker.py record <task_type> <model> <input_tokens> <output_tokens>
```
...
python3 scripts/shannon-scud/token-tracker.py record code_simple deepseek-coder 5000 2000

# Quality code with premium model
python3 scripts/shannon-scud/token-tracker.py record code_quality claude-sonnet-4-5 5000 2000
```
...
```bash
python3 scripts/shannon-scud/token-tracker.py recommend <task_type>
```

**Example**:
```bash
python3 scripts/shannon-scud/token-tracker.py recommend research
...
```bash
python3 scripts/shannon-scud/multi-provider-router.py compare <task_type> <input_tokens> <output_tokens>
```

**Example**:
```bash
python3 scripts/shannon-scud/multi-provider-router.py compare code_quality 5000 2000
```
...
python3 scripts/shannon-scud/multi-provider-router.py recommend research
...
```bash
# Record usage
python3 scripts/shannon-scud/token-tracker.py record \
  research \
  gemini-flash \
  <input_tokens> \
  <output_tokens>
...
python3 scripts/shannon-scud/token-tracker.py record research gemini-flash 2345 1234
```
...
python3 scripts/shannon-scud/token-tracker.py record test gemini-flash 100 100
```
...
│                                                              │
│  🔀 COMPARE COSTS                                           │
│  python3 scripts/shannon-scud/multi-provider-router.py \    │
...
- `scripts/shannon-scud/token-budget-config.yaml` — Configuration reference
